 ...
 * create by freemaker
 */
public class CommentBeanProvider extends BaseProvider {
    public static final String AUTHORITY = "com.potato.sticker.main.data.db.CommentBeanProvider";
    public static final String TABLE_PATH = "CommentBeanTB";
