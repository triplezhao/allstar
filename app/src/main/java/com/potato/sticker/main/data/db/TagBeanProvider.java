 ...
 * create by freemaker
 */
public class TagBeanProvider extends BaseProvider {
    public static final String AUTHORITY = "com.potato.sticker.main.data.db.TagBeanProvider";
    public static final String TABLE_PATH = "TagBeanTB";
