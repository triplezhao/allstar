 ...
 * create by freemaker
 */
public class TopicBeanProvider extends BaseProvider {
    public static final String AUTHORITY = "com.potato.sticker.main.data.db.TopicBeanProvider";
    public static final String TABLE_PATH = "TopicBeanTB";
