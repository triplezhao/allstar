...
import com.potato.sticker.main.ui.adapter.ReTopicAdapter;

import java.util.ArrayList;
import java.util.List;

public class ReTopicListFragment extends BaseFragment {
    ...
    private ReTopicAdapter mAdapter;
    private int mTotal = 1;
    private int mPage = 1;
    private FragmentTopicListReBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.inflate(
                ...
                R.layout.fragment_topic_list_re,
                container,
                false);
